...
void ToolPathParametersEditorWidget::setToolPathConfig(const noether_msgs::ToolPathConfig& config)
{
  ...
  ui_->double_spin_box_max_bridge_distance_he->setValue(config.halfedge_generator.max_bridge_distance);
...
noether_msgs::ToolPathConfig ToolPathParametersEditorWidget::getToolPathConfig() const
{
  ...
  config.halfedge_generator.max_bridge_distance = ui_->double_spin_box_max_bridge_distance_he->value();
